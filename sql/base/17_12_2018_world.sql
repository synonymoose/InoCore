...
-- Dumping structure for table world.achievement_criteria_custom
...
CREATE TABLE IF NOT EXISTS `areatrigger_template` (
  ...
  `eff_index` smallint(3) unsigned NOT NULL DEFAULT '0',
...
-- Data exporting was unselected.
-- Dumping structure for table world.battle_pet_ability_data
CREATE TABLE IF NOT EXISTS `battle_pet_ability_data` (
...
-- Data exporting was unselected.
-- Dumping structure for table world.battle_pet_ability_effect_data
CREATE TABLE IF NOT EXISTS `battle_pet_ability_effect_data` (
  `effectId` int(10) unsigned NOT NULL DEFAULT '0',
  `powerMod` float unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`effectId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Data exporting was unselected.
-- Dumping structure for table world.battle_pet_breed
...
-- Data exporting was unselected.
-- Dumping structure for table world.battle_pet_quality
...
-- Data exporting was unselected.
-- Dumping structure for table world.battle_pet_xp_for_level
CREATE TABLE IF NOT EXISTS `battle_pet_xp_for_level` (
...
-- Data exporting was unselected.
-- Dumping structure for table world.character_aura
...
-- Data exporting was unselected.
-- Dumping structure for table world.character_aura_effect
...
-- Data exporting was unselected.
-- Dumping structure for table world.character_raid
...
-- Data exporting was unselected.
-- Dumping structure for table world.cold_cnew
CREATE TABLE IF NOT EXISTS `cold_cnew` (
...
CREATE TABLE IF NOT EXISTS `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1005020 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
...
-- Data exporting was unselected.
-- Dumping structure for table world.creature_addon_copy
...
-- Data exporting was unselected.
-- Dumping structure for table world.creature_addon_qsdsqd
...
-- Data exporting was unselected.
-- Dumping structure for table world.creature_copy
CREATE TABLE IF NOT EXISTS `creature_copy` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=303341 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
...
-- Data exporting was unselected.
-- Dumping structure for table world.creature_formations_copy
...
CREATE TABLE IF NOT EXISTS `creature_loot_template` (
  ...
  `Reference` mediumint(8) unsigned NOT NULL DEFAULT '1',
...
-- Data exporting was unselected.
-- Dumping structure for table world.creature_raid_respawn
...
-- Data exporting was unselected.
-- Dumping structure for table world.creature_transport_copy
...
-- Data exporting was unselected.
-- Dumping structure for table world.daily_players_reports
...
CREATE TABLE IF NOT EXISTS `gameobject` (
  ...
  PRIMARY KEY (`guid`)
) ENGINE=MyISAM AUTO_INCREMENT=1530723 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Gameobject System';
...
-- Data exporting was unselected.
-- Dumping structure for table world.gameobject_raid_respawn
...
CREATE TABLE IF NOT EXISTS `game_tele` (
  ...
  `name` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1668 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
...
CREATE TABLE IF NOT EXISTS `gossip_menu_option` (
  `menu_id` mediumint(5) unsigned NOT NULL DEFAULT '0',
...
-- Data exporting was unselected.
-- Dumping structure for table world.guild_finder_applicant
...
-- Data exporting was unselected.
-- Dumping structure for table world.guild_finder_guild_settings
...
-- Data exporting was unselected.
-- Dumping structure for table world.itemlimitcategory_dbc
...
-- Data exporting was unselected.
-- Dumping structure for table world.item_extended_cost
...
CREATE TABLE IF NOT EXISTS `item_template` (
  ...
  `stat_value5` smallint(11) unsigned NOT NULL DEFAULT '0',
...
-- Data exporting was unselected.
-- Dumping structure for table world.item_upgrade_hotfix
CREATE TABLE IF NOT EXISTS `item_upgrade_hotfix` (
  `Id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `locales_gossip_menu_option` (
  `menu_id` mediumint(6) unsigned NOT NULL DEFAULT '0',
...
-- Data exporting was unselected.
-- Dumping structure for table world.map_challenge_mode_hotfixes
CREATE TABLE IF NOT EXISTS `map_challenge_mode_hotfixes` (
...
-- Data exporting was unselected.
-- Dumping structure for table world.players_reports_status
...
-- Data exporting was unselected.
-- Dumping structure for table world.quest_dynamic_reward
CREATE TABLE IF NOT EXISTS `quest_dynamic_reward` (
...
CREATE TABLE IF NOT EXISTS `quest_template` (
  ...
  `RequiredCurrencyCount1` smallint(5) unsigned NOT NULL DEFAULT '0',
  `RequiredCurrencyCount2` smallint(5) unsigned NOT NULL DEFAULT '0',
  `RequiredCurrencyCount3` smallint(5) unsigned NOT NULL DEFAULT '0',
  `RequiredCurrencyCount4` smallint(5) unsigned NOT NULL DEFAULT '0',
...
-- Data exporting was unselected.
-- Dumping structure for table world.quest_template_copy
...
-- Data exporting was unselected.
-- Dumping structure for table world.raid_encounters
...
-- Data exporting was unselected.
-- Dumping structure for table world.spell_areatrigger
...
-- Data exporting was unselected.
-- Dumping structure for table world.spell_bonus_loot
...
CREATE TABLE IF NOT EXISTS `spell_group_stack_rules` (
  ...
  `auraType` int(10) unsigned NOT NULL DEFAULT '0',
...
-- Data exporting was unselected.
-- Dumping structure for table world.time_diff_log
