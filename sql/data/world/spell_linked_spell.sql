...
-- Dumping data for table world.spell_linked_spell: 301 rows
...
INSERT INTO `spell_linked_spell` (`spell_trigger`, `spell_effect`, `type`, `comment`) VALUES
	...
	(110788, 110790, 2, 'Rogue - Cloak of Shadows'),
	...
	(132409, 24259, 0, 'Spell Lock (grimoire)'),
	...
	(115192, 1784, 2, 'Subterfuge'),
	(137619, 140149, 2, 'Marked for Death (check caster)'),
	(3411, 147833, 0, 'Intervene'),
	(119678, 172, 1, 'Soul swap with Soul Swap'),
	...
	(108415, 108446, 2, 'Soul Link'),
	(774, -114108, 0, 'Soul of the Forest (Rejuvenation)'),
	(33763, -114108, 0, 'Soul of the Forest (Lifebloom)'),
	(48438, -114108, 0, 'Soul of the Forest (Wild Growth)'),
	(16914, -114108, 0, 'Soul of the Forest (Hurricane)'),
	(8921, -114108, 0, 'Soul of the Forest (Moonfire)'),
	(-51755, -80325, 0, 'Remove Camouflage'),
	(89485, 96267, 0, 'Focalisation interieure'),
	(53301, 1130, 0, ''),
	...
	(77764, 96223, 2, 'Stampending Roar (cat) + run speed marker'),
	(77761, 96223, 2, 'Stampending Roar (bear) + run speed marker'),
	(2983, 96223, 2, 'Sprint + run speed marker'),
	(1850, 96223, 2, 'Dash + run speed marker'),
	(68992, 96223, 2, 'Darkflight + run speed marker'),
	(52417, 59077, 0, 'Carrying Seaforium - Remove'),
	(-114003, -116257, 0, 'exploit fix'),
	(-14771, -91724, 0, 'exploit fix'),
	(879, 147715, 0, 'energize on use'),
	(-81022, 131538, 0, ''),
	(122032, 147715, 0, 'energize on use'),
	(-51755, -80326, 0, 'Remove Camouflage'),
	(-51755, -119450, 0, 'Remove Camouflage'),
	(132157, 23455, 0, 'Sacred Nova heal at Sacred Nova cast'),
	(107570, 132169, 0, 'Storm Bolt(stun)'),
	(105771, 137637, 0, 'Warbringer slow effect'),
	(52410, -52415, 0, '');
